...
<p align="center">
  <img src="assets/contributions_2026.svg?v=4" alt="4nu81x 2026 Grid Telemetry" width="100%" style="margin-bottom: 10px;" />
  <br/>
  <img src="assets/contributions_2025.svg?v=4" alt="4nu81x 2025 Grid Telemetry" width="100%" />
</p>
...
[ INTERFACE ] :: Terminal-Style CLI Portfolio
-----------------------------------------------------------------
```
...
> High-speed browser extension and bookmarklet designed to filter academic and lab text (OSCP, HTB) into structured, Obsidian-ready Markdown notes. Includes CORS and HTTP-to-HTTPS tunneling workarounds via localtunnel.
